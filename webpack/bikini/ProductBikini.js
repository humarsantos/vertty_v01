var productBikini = {
    init: function (product) {
        var e = this,
            i = void 0 == product ? "" : product.handle.toLowerCase();
        ...
        if (this.mainCont = document.getElementsByClassName("main-featured")[0],
            ...
            void 0 === this.product) return !1;
        
        this.product.handle.indexOf("-") > -1 ? i = this.product.handle.split("-")[0] : i,
        this.bikiniType = document.getElementsByClassName(i),
        void 0 == this.product.description ? void 0 : this.descripTemporary.innerHTML = this.product.description;
        ...
        for (var h = 0; h < this.bikiniType.length; h++)
            ...
            this.bikiniType[h].pos = h, this.bikiniType[h].onclick = function (t) {
